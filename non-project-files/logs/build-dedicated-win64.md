UATHelper: Packaging (Windows (64-bit)): Dependencies are up to date. Skipping compile.
...
UATHelper: Packaging (Windows (64-bit)):     [52/54] UnrealPak-Projects.dll
...
UATHelper: Packaging (Windows (64-bit)):     [10/578] PCH.OpenExrWrapper.cpp
...
UATHelper: Packaging (Windows (64-bit)):     [74/578] Module.FacialAnimation.cpp
...
UATHelper: Packaging (Windows (64-bit)):     [138/578] Module.OnlineSubsystemNull.cpp
...
UATHelper: Packaging (Windows (64-bit)):     [202/578] c_loops.cc
...
UATHelper: Packaging (Windows (64-bit)):     [265/578] Module.Localization.cpp
...
UATHelper: Packaging (Windows (64-bit)):     [328/578] Module.BuildPatchServices.gen.cpp
...
UATHelper: Packaging (Windows (64-bit)):     [391/578] Module.MediaAssets.gen.cpp
...
UATHelper: Packaging (Windows (64-bit)):     [455/578] Module.Engine.25_of_45.cpp
...
UATHelper: Packaging (Windows (64-bit)):     [519/578] Module.Engine.44_of_45.cpp
...
UATHelper: Packaging (Windows (64-bit)):   LogCook: Display: Cooked packages 619 Packages Remain 30 Total 649
...
UATHelper: Packaging (Windows (64-bit)):   LogCookCommandlet: Display:     SerializeExportsTimeSec=0.207394
UATHelper: Packaging (Windows (64-bit)):   LogCookCommandlet: Display:     SerializeBulkDataTimeSec=0.000000
UATHelper: Packaging (Windows (64-bit)):   LogCookCommandlet: Display:     AsyncWriteTimeSec=0.000000
UATHelper: Packaging (Windows (64-bit)):   LogCookCommandlet: Display:     MBWritten=17.355850
...
UATHelper: Packaging (Windows (64-bit)):   LogCookCommandlet: Display: ============
UATHelper: Packaging (Windows (64-bit)):   LogCookCommandlet: Display:  0.CookWallTimeSec=92.279072
UATHelper: Packaging (Windows (64-bit)):   LogCookCommandlet: Display:  0. 0.StartupWallTimeSec=78.042975
UATHelper: Packaging (Windows (64-bit)):   LogCookCommandlet: Display:  0. 1.CookByTheBookTimeSec=14.226619
UATHelper: Packaging (Windows (64-bit)):   LogCookCommandlet: Display:  0. 1. 0.StartCookByTheBookTimeSec=5.527288
UATHelper: Packaging (Windows (64-bit)):   LogCookCommandlet: Display:  0. 1. 0. 0.GameCookModificationDelegateTimeSec=0.000048
UATHelper: Packaging (Windows (64-bit)):   LogCookCommandlet: Display:  0. 1. 1.TickCookOnTheSideTimeSec=8.671058
UATHelper: Packaging (Windows (64-bit)):   LogCookCommandlet: Display:  0. 1. 1. 0.TickCookOnTheSideLoadPackagesTimeSec=5.206946
UATHelper: Packaging (Windows (64-bit)):   LogCookCommandlet: Display:  0. 1. 1. 1.TickCookOnTheSideSaveCookedPackageTimeSec=2.937517
...
UATHelper: Packaging (Windows (64-bit)):   LogCookCommandlet: Display:  0. 1. 1. 2.TickCookOnTheSideBeginPackageCacheForCookedPlatformDataTimeSec=0.269954
UATHelper: Packaging (Windows (64-bit)):   LogCookCommandlet: Display:  0. 1. 1. 3.TickCookOnTheSideFinishPackageCacheForCookedPlatformDataTimeSec=0.004977
UATHelper: Packaging (Windows (64-bit)):   LogCookCommandlet: Display:  0. 1. 2.TickLoopGCTimeSec=0.000000
UATHelper: Packaging (Windows (64-bit)):   LogCookCommandlet: Display:  0. 1. 3.TickLoopRecompileShaderRequestsTimeSec=0.000887
UATHelper: Packaging (Windows (64-bit)):   LogCookCommandlet: Display:  0. 1. 4.TickLoopShaderProcessAsyncResultsTimeSec=0.000026
UATHelper: Packaging (Windows (64-bit)):   LogCookCommandlet: Display:  0. 1. 5.TickLoopProcessDeferredCommandsTimeSec=0.000062
UATHelper: Packaging (Windows (64-bit)):   LogCookCommandlet: Display:  0. 1. 6.TickLoopTickCommandletStatsTimeSec=0.000008
UATHelper: Packaging (Windows (64-bit)):   LogCookCommandlet: Display:
UATHelper: Packaging (Windows (64-bit)):   LogCookCommandlet: Display: DDC Summary Stats
UATHelper: Packaging (Windows (64-bit)):   LogCookCommandlet: Display: =================
UATHelper: Packaging (Windows (64-bit)):   LogCookCommandlet: Display: TotalGetHits    =       766
UATHelper: Packaging (Windows (64-bit)):   LogCookCommandlet: Display: TotalGets       =       766
UATHelper: Packaging (Windows (64-bit)):   LogCookCommandlet: Display: TotalGetHitPct  =  1.000000
UATHelper: Packaging (Windows (64-bit)):   LogCookCommandlet: Display: LocalGetHitPct  =  0.595300
UATHelper: Packaging (Windows (64-bit)):   LogCookCommandlet: Display: SharedGetHitPct =  0.000000
UATHelper: Packaging (Windows (64-bit)):   LogCookCommandlet: Display: OtherGetHitPct  =  0.404700
...
UATHelper: Packaging (Windows (64-bit)):   LogCookCommandlet: Display: ----------------------------------  ----------------  ---------------------  ------------  ------------
UATHelper: Packaging (Windows (64-bit)):   LogCookCommandlet: Display: PhysX (BodySetup)                               1.43                   1.43             0          2.76
UATHelper: Packaging (Windows (64-bit)):   LogCookCommandlet: Display: StaticMesh                                      0.73                   0.73             0          1.38
UATHelper: Packaging (Windows (64-bit)):   LogCookCommandlet: Display: NavCollision                                    0.36                   0.36             0          0.02
UATHelper: Packaging (Windows (64-bit)):   LogCookCommandlet: Display: SkeletalMesh                                    0.00                   0.00             0          3.38
...
UATHelper: Packaging (Windows (64-bit)):   LogInit: Display: -----------------------------------
UATHelper: Packaging (Windows (64-bit)):   LogInit: Display: CookResults: Warning: Unable to find package for cooking /Game/Maps/Highrise
UATHelper: Packaging (Windows (64-bit)):   LogInit: Display: LogCook: Warning: Unable to find package for cooking /Game/Maps/Highrise
UATHelper: Packaging (Windows (64-bit)):   LogInit: Display:
UATHelper: Packaging (Windows (64-bit)):   LogInit: Display: Success - 0 error(s), 2 warning(s)
UATHelper: Packaging (Windows (64-bit)):   LogInit: Display:
UATHelper: Packaging (Windows (64-bit)):   
UATHelper: Packaging (Windows (64-bit)):   Execution of commandlet took:  14.33 seconds
UATHelper: Packaging (Windows (64-bit)):   LogGauntlet: Display: Gauntlet Shutdown
UATHelper: Packaging (Windows (64-bit)): Took 110.3409984s to run UE4Editor-Cmd.exe, ExitCode=0
...
UATHelper: Packaging (Windows (64-bit)): Excluding config file D:\ue-engines\4.24-html\myengine\Engine\Config\BaseEditor.ini
UATHelper: Packaging (Windows (64-bit)): Excluding config file D:\ue-engines\4.24-html\myengine\Engine\Config\BaseEditorKeyBindings.ini
UATHelper: Packaging (Windows (64-bit)): Excluding config file D:\ue-engines\4.24-html\myengine\Engine\Config\BaseEditorPerProjectUserSettings.ini
UATHelper: Packaging (Windows (64-bit)): Excluding config file D:\ue-engines\4.24-html\myengine\Engine\Config\BaseEditorSettings.ini
UATHelper: Packaging (Windows (64-bit)): Excluding config file D:\ue-engines\4.24-html\myengine\Engine\Config\BaseLightmass.ini
UATHelper: Packaging (Windows (64-bit)): Excluding config file D:\ue-engines\4.24-html\myengine\Engine\Config\BasePakFileRules.ini
UATHelper: Packaging (Windows (64-bit)): Excluding config file D:\ue-engines\4.24-html\myengine\Engine\Config\Localization\Category.ini
UATHelper: Packaging (Windows (64-bit)): Excluding config file D:\ue-engines\4.24-html\myengine\Engine\Config\Localization\Editor.ini
UATHelper: Packaging (Windows (64-bit)): Excluding config file D:\ue-engines\4.24-html\myengine\Engine\Config\Localization\EditorTutorials.ini
UATHelper: Packaging (Windows (64-bit)): Excluding config file D:\ue-engines\4.24-html\myengine\Engine\Config\Localization\Engine.ini
UATHelper: Packaging (Windows (64-bit)): Excluding config file D:\ue-engines\4.24-html\myengine\Engine\Config\Localization\Keywords.ini
UATHelper: Packaging (Windows (64-bit)): Excluding config file D:\ue-engines\4.24-html\myengine\Engine\Config\Localization\PortableObjectExport.ini
UATHelper: Packaging (Windows (64-bit)): Excluding config file D:\ue-engines\4.24-html\myengine\Engine\Config\Localization\PortableObjectImport.ini
UATHelper: Packaging (Windows (64-bit)): Excluding config file D:\ue-engines\4.24-html\myengine\Engine\Config\Localization\PropertyNames.ini
UATHelper: Packaging (Windows (64-bit)): Excluding config file D:\ue-engines\4.24-html\myengine\Engine\Config\Localization\RepairData.ini
UATHelper: Packaging (Windows (64-bit)): Excluding config file D:\ue-engines\4.24-html\myengine\Engine\Config\Localization\ToolTips.ini
UATHelper: Packaging (Windows (64-bit)): Excluding config file D:\ue-engines\4.24-html\myengine\Engine\Config\Localization\WordCount.ini
UATHelper: Packaging (Windows (64-bit)): Excluding config file C:\Zlatnaspirala\active-projects\rocket-craft\rocket-craft\versions\4.24-Shooter\ShooterGame\Config\DefaultCrypto.ini
UATHelper: Packaging (Windows (64-bit)): Excluding config file C:\Zlatnaspirala\active-projects\rocket-craft\rocket-craft\versions\4.24-Shooter\ShooterGame\Config\DefaultEditor.ini
UATHelper: Packaging (Windows (64-bit)): Cleaning Stage Directory: C:\Zlatnaspirala\active-projects\rocket-craft\rocket-craft\versions\4.24-Shooter\ShooterGame\Saved\StagedBuilds\WindowsServer
UATHelper: Packaging (Windows (64-bit)): Creating pak using staging manifest.
UATHelper: Packaging (Windows (64-bit)): Executing 1 UnrealPak command...
UATHelper: Packaging (Windows (64-bit)): Waiting for child processes to complete (0/1)
UATHelper: Packaging (Windows (64-bit)): Waiting for child processes to complete (1/1)
UATHelper: Packaging (Windows (64-bit)): Output from: C:\Zlatnaspirala\active-projects\rocket-craft\rocket-craft\versions\4.24-Shooter\ShooterGame\ShooterGame.uproject C:\Zlatnaspirala\active-projects\rocket-craft\rocket-craft\versions\4.24-Shooter\ShooterGame\Saved\StagedBuilds\WindowsServer\ShooterGame\Content\Paks\ShooterGame-WindowsServer.pak -create=D:\
ue-engines\4.24-html\myengine\Engine\Programs\AutomationTool\Saved\Logs\PakList_ShooterGame-WindowsServer.txt -cryptokeys=C:\Zlatnaspirala\active-projects\rocket-craft\rocket-craft\versions\4.24-Shooter\ShooterGame\Saved\Cooked\WindowsServer\ShooterGame\Metadata\Crypto.json -order=C:\Zlatnaspirala\active-projects\rocket-craft\rocket-craft\versions\4.24-Shoot
er\ShooterGame\Build\WindowsServer\FileOpenOrder\CookerOpenOrder.log -encryptindex -sign -patchpaddingalign=2048 -compressionformats=  -multiprocess -abslog=D:\ue-engines\4.24-html\myengine\Engine\Programs\AutomationTool\Saved\Logs\UnrealPak-ShooterGame-WindowsServer-2021.09.23-18.52.12.txt
UATHelper: Packaging (Windows (64-bit)):   LogPakFile: Display: Parsing crypto keys from a crypto key cache file
UATHelper: Packaging (Windows (64-bit)):   LogCompression: Display: FCompression::GetCompressionFormat - Unable to find a module or plugin for compression format -multiprocess
UATHelper: Packaging (Windows (64-bit)):   LogPakFile: Display: Loading response file D:\ue-engines\4.24-html\myengine\Engine\Programs\AutomationTool\Saved\Logs\PakList_ShooterGame-WindowsServer.txt
UATHelper: Packaging (Windows (64-bit)):   LogPakFile: Display: Added 2593 entries to add to pak file.
UATHelper: Packaging (Windows (64-bit)):   LogPakFile: Display: Loading pak order file C:\Zlatnaspirala\active-projects\rocket-craft\rocket-craft\versions\4.24-Shooter\ShooterGame\Build\WindowsServer\FileOpenOrder\CookerOpenOrder.log...
UATHelper: Packaging (Windows (64-bit)):   LogPakFile: Display: Finished loading pak order file C:\Zlatnaspirala\active-projects\rocket-craft\rocket-craft\versions\4.24-Shooter\ShooterGame\Build\WindowsServer\FileOpenOrder\CookerOpenOrder.log.
UATHelper: Packaging (Windows (64-bit)):   LogPakFile: Display: Collecting files to add to pak file...
UATHelper: Packaging (Windows (64-bit)):   LogPakFile: Display: Collected 2593 files in 0.02s.
UATHelper: Packaging (Windows (64-bit)):   LogPakFile: Display: Creating signed pak C:\Zlatnaspirala\active-projects\rocket-craft\rocket-craft\versions\4.24-Shooter\ShooterGame\Saved\StagedBuilds\WindowsServer\ShooterGame\Content\Paks\ShooterGame-WindowsServer.pak.
UATHelper: Packaging (Windows (64-bit)):   LogPakFile: Display: Using encryption key 'Default' [00000000000000000000000000000000]
UATHelper: Packaging (Windows (64-bit)):   LogPakFile: Display: Added 2593 files, 33086947 bytes total, time 10.52s.
UATHelper: Packaging (Windows (64-bit)):   LogPakFile: Display: Encryption - ENABLED
UATHelper: Packaging (Windows (64-bit)):   LogPakFile: Display:   Files: 785
UATHelper: Packaging (Windows (64-bit)):   LogPakFile: Display:   Index: Encrypted (315072 bytes, 0.30MB)
UATHelper: Packaging (Windows (64-bit)):   LogPakFile: Display:   Total: 1586480 bytes (1.51MB)
UATHelper: Packaging (Windows (64-bit)):   LogPakFile: Display: Unreal pak executed in 10.848974 seconds
UATHelper: Packaging (Windows (64-bit)): UnrealPak terminated with exit code 0
UATHelper: Packaging (Windows (64-bit)): Copying NonUFSFiles to staging directory: C:\Zlatnaspirala\active-projects\rocket-craft\rocket-craft\versions\4.24-Shooter\ShooterGame\Saved\StagedBuilds\WindowsServer
...
UATHelper: Packaging (Windows (64-bit)): Archiving to C:/Users/Nikola Lukic/Desktop/TEST_BUILDS/SHOOTER/dedicated/win
