...
mod tests {
    use super::*;
    use crate::coordinate::{MechaCoordinateSystem, MechaSessionSimulation, SessionState};
    ...
    fn explore_single_state_no_errors() {
        let result = explore_state_space(&MechaCoordinateSystem, connecting_sim(), 1);
    ...
    fn explore_expands_connecting_to_reachable_states() {
        ...
        let result = explore_state_space(&MechaCoordinateSystem, connecting_sim(), 10);
    ...
    fn transitions_are_tuples_of_from_move_to() {
        let result = explore_state_space(&MechaCoordinateSystem, connecting_sim(), 5);
    ...
    fn zero_max_states_gives_empty_result() {
        ...
        let result = explore_state_space(&MechaCoordinateSystem, connecting_sim(), 0);
    ...
    fn errors_are_collected_not_panicked() {
        ...
        let result = explore_state_space(&MechaCoordinateSystem, connecting_sim(), 20);
    ...
    fn visited_count_does_not_exceed_max_states() {
        let max = 3;
        let result = explore_state_space(&MechaCoordinateSystem, connecting_sim(), max);
