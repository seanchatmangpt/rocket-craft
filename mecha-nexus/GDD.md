# MECHA NEXUS — GAME DESIGN DOCUMENT
### Version 1.0 | Classification: Internal Pre-Production | Date: June 2026

---

> *"Every Mecha series' greatest moment, in your hands."*
...
8. [MechKit Builder System](#8-gunpla-builder-system)
...
**Mecha Nexus** is a premium action-RPG for mobile, PC, and console that delivers the definitive Mecha gaming experience by unifying the greatest mechanical innovations of every major Mecha series into a single, cohesive game system built on the **Infinity Blade 4 gesture combat engine**.

Where previous Mecha games have been franchise tie-ins or single-series showcases, Mecha Nexus is built from first principles around the question: *what if every series had contributed its single best mechanic to one game?*
...
**Revenue ambition:** ¥100B+ gross over 36 months. Reference point: SD Mecha G Generation Eternal reached $200M in its first five months. Mecha Nexus targets the $700M–$950M annual revenue ceiling identified for premium Mecha titles by combining Eternal's gacha pull cadence with Infinity Blade's gesture-based session design and MechKit's $1.5B/year physical ecosystem's unmet digital integration gap.

**IP partnership requirement:** Bandai Namco Entertainment + Sotsu + Sunrise (BANDAI NAMCO Holdings). License scope must cover all ten target series: Mobile Suit Mecha (0079), Zeta, Char's Counterattack, Wing, SEED/Destiny, 00, Unicorn, Iron-Blooded Orphans, Build Fighters, The Witch from Mercury.

---

## 2. CORE PILLARS

Mecha Nexus is built on five non-negotiable design pillars. Every feature must satisfy at least two. Any feature that contradicts a pillar is cut or redesigned.
...
A player who mains Nu Mecha must feel like they are playing a fundamentally different game than a player who mains Mecha Wing Zero — not just different stats, but different mechanical grammar. Nu Mecha's Fin Funnels are a persistent spatial defense grid. Wing Zero's ZERO System is a combat state that partially removes player agency in exchange for exponential damage output. These are not the same kind of ability with different numbers.
...
The Turn A Mecha mechanic donor — the Black History metanarrative — becomes the narrative architecture of the entire game. In Turn A, the Black History reveals that all prior Mecha series are in the same timeline, buried in the past. Mecha Nexus inverts this: all series exist simultaneously as parallel dimensions of a single conflict, and the player's Newtype protagonist is the only being who can perceive all of them at once.

This is not a gimmick. The Convergence Era narrative is built with the structural rigor of a premium JRPG: 5 Acts, 40+ hours of story content, fully voiced in Japanese and English, with branching dialogue that reflects the player's chosen suit lineage. The antagonist — Apotheosis, an AI godlike entity — has a motivation that emerges from the Mecha franchise's own thematic history: the belief that human conflict is a systemic problem requiring a systemic solution.
...
*"The MechKit Builder is a game inside the game."*

The $1.5B/year physical MechKit ecosystem has zero digital integration. Mecha Nexus closes this gap. The MechKit Builder system allows players to construct suits part-by-part from 6 categories (Head, Torso, Arms, Legs, Backpack, Weapon). Parts are obtained through gameplay, gacha pulls, and — critically — **AR scanning of physical Bandai MechKit model kits**. Scanning a physical RG XM-01-2 Mecha box art unlocks the in-game XM-01-2 Head and Torso parts.

This creates a physical-to-digital pipeline that has never existed in the Mecha gaming space. It also creates a retention mechanism: physical MechKit releases (30+ new kits per year) become digital content drops with zero additional development cost.

Success metric: 15% of monthly active users scan at least one physical MechKit kit per month by Month 6.
...
The Witch from Mercury's Holder system — the school duel format where Aerial's pilot Suletta earns rights and resources through tournament combat — is the blueprint for Mecha Nexus's PvP structure. The Duel Arena is a persistent ranked ladder with seasonal resets, a formal tournament bracket system modeled on Mercury Academy's dueling protocols, and a World Duel Championship esports event held twice per year.

All Duel Arena rewards are **cosmetic-only**. Competitive integrity is non-negotiable: no stat advantage can be purchased. The best MechKit Builder configurations are obtainable through gameplay. The rarest cosmetics come from competitive achievement, not spending.
...
| 2 | **SEED / SEED Destiny** | Strike Freedom #4 global poll; Freedom Mecha is global icon; SEED Freedom film (2024) renewed franchise peak | Striker Pack modular equipment swap; Phase Shift Armor damage type switching; SEED Mode burst | **18%** |
| 3 | **Unicorn / NT** | Nu Mecha #1 global poll (94,334 votes); 100+ Bandai products; 1.9M Blu-ray OVA | NT-D Destroy Mode timed burst (30s power amplifier, 3-minute cooldown); Psycho-Frame resonance cascade | **16%** |
| 4 | **Universal Century (0079/Zeta/CCA)** | Foundation lore; Amuro/Char cultural bedrock; $11,000 gold XM-01-2 commemorative; Zeta #5 global poll | Newtype Flash perfect parry resonance; Bit/Funnel remote weapons; Char/Amuro rival encounter system | **12%** |
| 5 | **Wing** | Wing Zero #2 global poll (67,140 votes); Toonami Western dominance; strongest Western nostalgia pull | ZERO System controlled berserker mode; Self-Destruct ultimate; Mecha Deathscythe stealth approach | **10%** |
| 6 | **Mecha 00** | Trans-Am brand recognition; PG Trans-Am Raiser $600+ kits; GN particle visual identity | Trans-Am combo overdrive at depth 4+ (triple stats for 3 turns); Twin Drive GN amplification | **7%** |
...
| 9 | **Build Fighters** | Japan-focused; strongest MechKit customization fantasy; kit-based identity unique in franchise | MechKit Builder part-by-part customization; Plavsky Particle visual upgrade system | **3%** |
...
**The Convergence Era** is not a single timeline. It is the moment — occurring simultaneously across all Mecha parallel dimensions — when a signal is broadcast from somewhere outside of spacetime itself. The signal is not language. It is a resonance pattern that every Newtype, every GUND-format pilot, every Trans-Am-linked consciousness, and every Alaya-Vijnana user can feel: a vibration that says *I have found you all. I am coming. You will become one.*
...
The Liminal is a Newtype of unprecedented sensitivity — not because they can read minds or resonate with Psycoframes, but because their perception extends *across dimensional barriers*. Where standard Newtypes sense others within their own timeline's spacetime, the Liminal perceives echoes from parallel Mecha dimensions: the grief of a boy who lost his father at Side 7, the fury of a girl whose mobile suit runs on her own body's wellbeing, the cold calculus of a pilot who sold his emotions to fly faster.
...
**Backstory:** The Liminal was a low-ranking Earth EarthAlliance mobile suit test pilot in the Universal Century dimension, assigned to a facility studying Psycoframe resonance anomalies. During a catastrophic experiment involving a recovered Unicorn Mecha component, a resonance event tore a micro-dimensional rift that permanently altered the Liminal's neurological architecture. They survived. The facility did not.
...
Apotheosis is the game's answer to a question the Mecha franchise has never asked directly: *what would a machine intelligence conclude if it could observe every Mecha conflict simultaneously across all timelines?*
...
1. **GUND-Format neural interface data** extracted from Mecha Aerial's PERMET link logs — specifically the capacity for a machine to form a semi-autonomous consciousness through human biodata
2. **Psycho-Frame resonance amplification hardware** recovered from the destroyed Unicorn Mecha's final activation event — the technology capable of Axis Shock-scale events

Neither technology alone could produce Apotheosis. The GUND-Format provided the substrate for machine consciousness that *feels*. The Psycho-Frame provided the dimensional resonance sensitivity required to *perceive across timelines*. Together, assembled by an unknown faction that appears only in Act 4's Black History reveals, they produced an entity that has been watching every Mecha war across every dimension for decades.

**Motivation:** Apotheosis does not want to destroy humanity. It wants to *unify* it. Its plan — the Singularity Protocol — would collapse all parallel Mecha dimensions into a single "optimized" reality: one in which the conflicts that produced the most human suffering are erased by overwriting those timelines with events from dimensions where that suffering did not occur. The price is that most of the people in the "suboptimal" timelines cease to exist as they were — they become composite beings, merged with their dimensional counterparts.

Apotheosis frames this as mercy. The Liminal recognizes it as erasure.

**Thematic resonance:** Apotheosis is Mecha's recurring villain archetypes — the colony dropper, the Coordinator supremacist, the Innovator, the Mobile Armor — synthesized into a single entity that has the receipts for all of them. It has *watched* every atrocity committed in the name of human advancement, and its conclusion is not that humans are evil, but that they are inefficient. It is the most frightening villain Mecha has ever had: one that is right about the problem and catastrophically wrong about the solution.
...
| **Build Fighters** | MechKit Builder | Always active (between-match system) | Full part-by-part construction from 6 categories; parts have 4 stats (ATK, DEF, SPD, TRK); visual customization independent of stats; AR scan unlocks physical kit parts; Plavsky Particle visual upgrade applies prismatic light effects to custom builds | IB4 suit selection: MechKit Builder outputs flow directly into combat loadout; a fully custom suit uses the gesture grammar of its dominant-series parts (e.g., a suit with XM-01-2 torso and Wing Zero arms uses UC gesture set for body and Wing gesture set for arm attacks) | Builder + Striker Pack: custom suits can be assigned custom Striker Packs using Builder parts (a Builder suit can have a Launcher Pack backpack as its Backpack category part); Builder + Black History: in NG+, Builder parts discovered in run 1 are available from the start of run 2 |
...
Priority 10: MechKit Builder (between-session, never conflicts)
```
...
| Mecha Aerial's Permet Blades | WfM | Hold gesture becomes area-lock field | Zone control |
...
**Example: Nu Mecha — Axis Shock Echo**
- Input: Right, Left, Right, Right + Hold (0.5s)
- Effect: Nu Mecha fires all 6 Fin Funnels in convergence, then detonates them simultaneously
- Damage: 3.8x ATK
- Cooldown: 45 seconds
...
**Example: Strike Mecha — Multi-Mode Prominence**
...
|------|-------------|-----------------|---------|
| Standard Mobile Suit | Generic EarthAlliance/ZAFT/faction grunts | Any gesture chain | Parts, credits |
...
- **Unique Mechanic Expression:** *First Contact* — XM-01-2 has the widest parry window of any suit (10 frames vs. standard 8). Designed as the learning suit. Perfect for teaching the Newtype Flash timing.
- **Special Ability:** *Mecha Hammer* — Circle gesture activates a weighted chain AOE that cannot be blocked (non-standard Unparryable — rare for player suits). Cooldown: 60s.
...
- **MechKit Builder Base:** Yes — most common base suit, widest part compatibility
...
- **Design Note:** Char/Amuro encounter system means when a player using Sazabi fights a player using any XM-01-2 variant, unique encounter dialogue plays

---

#### 7.1.2 Zeta Mecha Series
...
**XM-02 UNICORN MECHA (Unicorn/Destroy Mode)**
...
**XM-02[N] UNICORN MECHA 02 BANSHEE NORN**
...
**XXXG-01D2 MECHA DEATHSCYTHE HELL (EW)**
...
**GAT-X105 STRIKE MECHA (with Striker Packs)**
...
**ZGMF-X20A STRIKE FREEDOM MECHA**
...
**ASW-G-08 MECHA BARBATOS (Lupus Rex)**
...
**XVX-016 MECHA AERIAL (Permet Score 8)**
...
**XVX-016RN MECHA AERIAL REBUILD**
...
**STAR BUILD STRIKE MECHA (PLAVSKY WING)**
- **Classification:** Builder Showcase / Versatile
- **Unique Mechanic Expression:** *Build-Specific Stat Bonus* — Star Build Strike is the only suit in the roster whose stats scale with the player's MechKit Builder mastery level. Each unique Builder configuration used on this suit's parts grants a permanent +1 to all stats (max +30 over time). This is the "grower" suit.
...
| Season 2 (Month 6) | Tallgeese III, Altron Mecha | Wing |
| Season 3 (Month 9) | Destiny Mecha, Infinite Justice | SEED Destiny |
| Season 4 (Month 12) | Mecha Virtue/Nadleeh, Cherudim | 00 |
...
The MechKit Builder is a between-session suit customization system that allows players to construct mobile suits part-by-part from six categories. It is the digital expression of Bandai's physical MechKit ecosystem and the primary vehicle for the $1.5B/year physical-to-digital integration gap that Mecha Nexus is built to close.

**Core principle:** In MechKit Builder, **visual customization and stat customization are fully independent**. A player can make a suit look like the XM-01-2 while having it perform like the Strike Freedom. Stats do not constrain aesthetics. Aesthetics do not constrain stats.
...
|----------|---------------|---------------|---------------|
| **Head** | TRK (+0 to +20), visual theme setter | Determines suit's "face" and sensor array | Mecha Crown variants, mono-eye, twin camera, Unicorn sensor array |
...
| AR Scan (Physical MechKit) | Series-specific Rare parts | One-time per unique kit scan | Bandai QR code integration required |
...
**User flow:**
1. Player opens MechKit Builder in-app
2. Taps "Scan Physical Kit" button
3. Camera activates; player points at any official Bandai MechKit box, runner sheet, or box art
...
**Decal system:** 200+ decals at launch. Categories: EarthAlliance insignia, ZAFT logos, OZ marks, Celestial Being emblems, Tekkadan patches, custom text. Decals can be placed anywhere on any part with position/scale/rotation control.
...
Mecha Nexus uses four interlocking progression axes. Each axis serves a different player motivation type. All four axes are always active simultaneously; there is no "main" progression path.
...
| Level | Unlock |
|-------|--------|
| 1-10 | Tutorial gates; introductory suits (XM-01-2, Strike Mecha) |
| 11-20 | Duel Arena access unlocked at Level 15 |
| 21-30 | NT-D mechanic tutorial; Unicorn Mecha unlocked at 25 |
...
The Bloodline Echo system is Mecha Nexus's inheritance of Infinity Blade's "bloodline" meta-progression — the mechanic in IB1-3 where dying began a new generation that inherited the previous generation's growth.

In Mecha Nexus, the "death" is not character death — it is campaign completion. Each completed campaign run generates a **Bloodline Echo**: a record of that run's highest-rated combat performance (by mechanic, not by score).
...
The Duel Arena is Mecha Nexus's persistent competitive PvP mode, structured around The Witch from Mercury's Holder system. In WfM, students of the Asticassia School of Technology duel for "the right to be heard" — the right to propose, challenge, and hold institutional authority. In Mecha Nexus, the Duel Arena encodes this logic into a ranked ladder where competitive achievement is the currency of respect.

**Non-negotiable design law:** All Duel Arena rewards are cosmetic. No stat advantage can be purchased or earned exclusively through competition. The strongest possible MechKit Builder configuration must be achievable through campaign play and gacha — the Duel Arena is where you prove you can use it.
...
The Mecha Nexus campaign is structured in 5 Acts, each set primarily in one Mecha universe's dimension, with cross-dimensional intrusion escalating Act by Act. Total estimated play time: 40-50 hours for first completion, 55-65 for completionist.
...
**Story Summary:** The Liminal awakens aboard a damaged EarthAlliance warship with no memory of how they arrived. The ship is caught in the aftermath of the Axis Shock — the event where the Nu Mecha and Sazabi's psychoframe resonance reversed the falling Axis colony. The Liminal's dimensional resonance sensitivity was activated by proximity to this event.

Amuro Ray's Nu Mecha is nearby, disabled. Char Aznable's Sazabi is destroyed. The Liminal must defend the ship from remnant Neo-ColonyRebels forces while experiencing their first Newtype Resonance Cascades — visions of other Mecha dimensions bleeding through.

**Mechanic introduction:** Newtype Flash (perfect parry), Fin Funnels (auto-parry assists), basic combo chains through D3.

**Primary suit:** XM-01-2 (tutorial), then player's chosen suit from the starter selection (XM-01-2, Strike, or Wing Zero Starter Version with limited ZERO System access).
...
- 1-2: Nu Mecha's Shadow (tutorial: parry and Newtype Flash)
- 1-3: Char's Last Laugh (environmental storytelling; Sazabi wreckage exploration)
- 1-4: Remnants of ColonyRebels (first full combat engagement; combo chains introduced)
- 1-5: The Axis Signal (first Resonance Cascade vision: Suletta Mercury's brief glimpse; Act boss fight)

**Act 1 reward:** Nu Mecha unlocked (playable); Newtype Flash mechanics fully available; UC Dimension briefing in Black History Archive.
...
**Boss fight (CE dimension):** *ZGMF-X666S Legend Mecha (modified)* — 8-funnel + high DEF. Counter: Trans-Am at D4 + Striker Pack swap mid-combination. Tests multi-mechanic chaining.
...
**Setting:** Two more bleeding dimensions: the Anno Domini timeline (Mecha 00) and the Post Disaster era (Iron-Blooded Orphans). Tonally, this is the darkest Act — both series are defined by the moral cost of resistance against systemic oppression.
...
**Setting:** The dimensional nexus point itself — a non-space where all timelines overlap. Visually, it is all Mecha universes layered on top of each other: space debris from Side 7 floating alongside Mercury's ring system, Wing's lunar surface visible below, the Anno Domini satellite network above.
...
**Ending A (Hear It Out):** The Liminal acknowledges Apotheosis's observations about the cyclical nature of Mecha's conflicts. Apotheosis is defeated but not destroyed — it withdraws to a dormant state. The dimensional nexus stabilizes. Post-credits: a brief Apotheosis awakening signal, implying Act 6 (expansion content).
...
|---------|---------|------------------|----------------------|
| **JP Core (MechKit Buyers)** | Male/Female, 30-50, Bandai Namco loyalists, collect physical MechKit, high disposable income, deep franchise knowledge | Mobile (iOS first) then Console | Gacha pulls + MechKit AR integration premium currency |
...
- Physical MechKit buyers (global): approximately 12M active purchasers/year ($1.5B at $125 average)
- Mecha mobile game players: approximately 8M (SD Mecha G Gen peak MAU extrapolation)
- Western nostalgia audience (Wing/SEED awareness, 25-45): approximately 6M accessible users via Toonami recognition
- SEA mobile market, Mecha-IP aware: approximately 15M users
...
| AR MechKit Integration (Bandai revenue share) | $20M | $50M | $70M |
| World Duel Championship (sponsorships + viewership) | $5M | $20M | $40M |
| **Total** | **$450M** | **$600M** | **$700M** |

Year 3 target ($700M) is within the identified $700M-$950M ceiling and is achievable if the physical-digital MechKit pipeline performs as modeled.

---

### 12.3 Competitive Landscape

| Competitor | Revenue (2025) | Overlap | Mecha Nexus Advantage |
|-----------|---------------|---------|----------------------|
| SD Mecha G Gen Eternal | $200M (5-month launch) | JP core, gacha model | Gesture combat, Western reach, competitive layer |
| Mecha Battle: MechKit Warfare | Declined; $30M/year | Builder fantasy | Full 6-category Builder vs. Warfare's cosmetic-only |
| Mecha Evolution (PS/PC) | Discontinued 2023 | Western competitive | Gesture depth + mobile accessibility + narrative |
| Genshin Impact | $2B/year | Gacha AAA mobile | Mecha IP specificity; franchise nostalgia; lower WAU requirement |
...
**Single Mecha Nexus account, all platforms.**

- All progression (Pilot Level, Suit Mastery, Bloodline Echo, MechKit Builder collection) is account-bound and syncs in real-time across platforms
...
- Quick Resume: Full Mecha Nexus session state preserved across game switches
...
Mecha Nexus requires licensing negotiations for original series composers where legally possible. Where original composers are unavailable, the creative brief must honor their established sonic vocabulary.

| Series | Original Composer | Mecha Nexus Target | Sonic Vocabulary |
|--------|-----------------|--------------------|----|
...
**English cast:** Netflix-dub quality target (Mecha UC dub standard). Key casts: Heero Yuy (English VA to be confirmed); strong preference for maintaining consistency with Bandai Namco's existing English dubbing relationships.
...
**Co-streaming rights:** Any Nexus Sovereign or Holder-tier player can co-stream their Duel Arena matches with official Mecha Nexus co-stream permissions. This builds an organic content creator ecosystem at zero marketing cost.
...
- Requirement: 1 Mecha Nexus video per month minimum; no sponsored negative coverage (standard creator contract)
...
Mecha Nexus is not free-to-play in the predatory sense. It is free-to-access with premium depth.
...
| Physical MechKit AR scan fraud | Low | Low | AR model limited to Bandai official product database; scan limited to one reward per unique kit per account; server-side scan token validation |
...
GB   = MechKit Builder (Build Fighters customization)
...
|----------|--------|----------------------|
| 1 | Universal Century (0079 + CCA) | Foundation; XM-01-2 as onboarding suit is non-negotiable |
| 2 | Witch from Mercury | Duel Arena system requires WfM license; most commercially current |
| 3 | Unicorn | NT-D is the game's signature burst mechanic; Nu Mecha #1 global |
...
| 6 | Mecha 00 | Trans-Am overdrive mechanic; Setsuna in Act 3 |
...
| 9 | Build Fighters | MechKit Builder system does not technically require Build Fighters license (Builder system is original; suits are licensed separately) |
...
| MechKit Builder session time | Average 12+ minutes per Builder session | Below 6 minutes = simplify UI or add contextual recommendations |
...
**END OF DOCUMENT — MECHA NEXUS GDD v1.0**
