# Mecha Nexus — Combinatorial Systems Design
...
**Philosophy:** Combinatorial Maximalism — each Mecha series contributes one irreducible mechanical identity; no two systems are synonymous; all systems interact meaningfully without canceling each other out  
...
Mecha as a franchise spans 45+ years and 20+ distinct series. Each series has a visual identity, a thematic identity, and — crucially for Mecha Nexus — a mechanical identity. The Witch from Mercury's central dramatic engine is the duel. Iron-Blooded Orphans is built around the violence of close-quarters melee and the physical toll of the Alaya-Vijnana system. Turn A is fundamentally about cycles, repetition, and the cost of accumulated history.

Mecha Nexus does not flatten these distinctions. Every major series is given one mechanical system that cannot be replicated by any other series. These systems layer — a pilot using Barbatos in a Witch from Mercury Duel Arena, while activating the Alaya-Vijnana Interface and building toward a Newtype Flash, is experiencing three different series' mechanical languages simultaneously. This is the combinatorial payoff.
...
Players who master one system are not automatically competent with another. Mastery of all ten systems simultaneously is the skill ceiling of Mecha Nexus. Casual players can thrive with one or two. This design range supports both mobile-casual and esports-competitive play.
...
- **XM-01-2 Mecha:** Wide horizontal sweeps, Amuro-era deliberate style, saber held at midpoint
...
- **Destiny Mecha:** Dual-wield animation; left and right gesture triggers separate sabers simultaneously (unique exception to one-saber standard; balanced by smaller per-hit damage)
...
- Mechanic: "Mecha Aerial echo" — once per match, a spectral Mecha Aerial silhouette appears and performs a random gesture attack on both players (equal threat); telegraphed 2 seconds before
...
- Visual: Market stalls as background detail, cramped urban setting, scale mismatch (Mecha-sized suits in human-scale market)
...
- **OG Only:** Only original suits (non-canon suits created for the game or MechKit Builder custom suits). Pure player expression match.
- **Single Series:** All participants must use suits from the same Mecha series (e.g., "SEED Week" — only SEED/SEED Destiny suits). Creates thematic focused events.
...
**Strike Mecha (Native):** All three packs; 0.5s swap. The reference implementation.
...
**Infinite Justice Mecha:** Pack integrated permanently — Fatum-00 backpack is the "fourth pack type" unique to Justice. Cannot swap. No stat penalty for fixed config; Fatum-00 provides both +15% melee and +10% ranged simultaneously. Balance: no Phase Shift first-hit negation.

**Destiny Mecha:** Ships with a preset Striker configuration (Aile base + integrated weapons). Cannot swap packs mid-combat. Instead, Destiny's unique system is "Mirage Colloid Burst" — a 3-second afterimage decoy triggered by tap-down that absorbs one attack.

**Aegis Mecha:** Unique "Mobile Armor transformation" — instead of Striker swaps, Aegis can toggle between MA form (ranged, +30% beam damage, immobile) and MS form (mobile, standard stats) with a 1.0s transformation. Aegis does not equip standard Striker Packs.

### Economic Model

**How Packs Are Obtained:**
- Crafting via MechKit Parts (Build Fighters system): Combine 3 Backpack parts + 1 Weapon part = any Striker Pack (standard version)
...
- AR Bridge: Certain MechKit kits include a Striker Pack unlock (e.g., MG Strike Mecha with Aile pack includes digital Aile Striker)
...
**Series Basis:** Mobile Suit Mecha Unicorn  
...
Unicorn's NT-D system is the defining "transformation" in post-UC Mecha. The Unicorn Mecha shatters its seals, the psycho-frame ignites, and for thirty seconds it becomes something beyond a mobile suit. Mecha Nexus represents this as the game's most dramatic single activation: a timed power state with extraordinary bonuses, a mandatory narrative moment, and suit-specific variations that express each Unicorn-series unit's distinct relationship with the NT-D system.
...
- Unicorn Mecha suit breaks open (head horn splits, panels reveal psycho-frame underneath)
...
**Unicorn Mecha (XM-02):** Standard NT-D as described above.

**Banshee Norn (XM-02[N]):** "NTD Override" — aggressive variant
...
- Visual: Gold/black aura; Neo ColonyRebelsg psycommu claws extend as visual effect (no mechanical effect)
...
**Phenex (XM-02 Phenex):** "NT Resonance" — support variant
...
**Series Basis:** Mobile Suit Mecha 00  
...
Trans-Am in Mecha 00 represents Celestial Being's trump card — a state of maximum output that burns through GN particle reserves, leaving the suit weakened after use. The reward is extraordinary; the cost is real. This risk/reward asymmetry is the heart of the 00 system in Mecha Nexus.
...
**Reborns Mecha:** "Twin Trans-Am" variant
- Reborns can switch between Mecha mode and Cannon mode (separate from Striker packs; it's a full MS-to-MA transformation)
...
**Series Basis:** New Mobile Report Mecha Wing  
...
The ZERO System in Wing is not a power-up. It is a curse. It shows pilots the future — specifically the future in which they win — but the psychological burden of experiencing that possible future warps the pilot's mind toward ruthlessness. Heero, Zechs, and Quatre all struggle with it. In Mecha Nexus, the ZERO System is represented as a system that offers the player a choice: accept its assistance and its cost, or decline and face a penalty. This is the only game system with a moment of explicit player agency during activation.
...
**Wing Mecha Zero (XXXG-00W0):** Full ZERO as described above.
...
**Series Basis:** Mobile Suit Mecha: Iron-Blooded Orphans  
...
The Alaya-Vijnana system in IBO is not a choice. It is installed in the pilot's spine. It enhances combat ability in ways that are measurable and decisive; it also extracts a physical toll. Mikazuki Augus, the most skilled AVJ user, has adapted to this toll; other pilots pay for it incrementally. Mecha Nexus captures this through a passive system that is always active but costs HP for non-native users — a persistent tax on the enhanced capability.
...
**Series Basis:** Turn A Mecha  
**System Type:** New Game Plus meta-progression system  
**Layer:** Meta (applies to the game itself, not to individual matches)

### Design Premise

Turn A Mecha's defining revelation is the "Black History" — a buried record of all the civilizations that rose, fought, and destroyed each other before the current era. The series treats history as cyclical: the same conflicts recurr across millennia. Mecha Nexus literalizes this: your playthrough history becomes the game's history, and the game changes in response.
...
Turn A Mecha's final weapon is the Moonlight Butterfly — a swarm of nanomachines that dissolves all technology. In Mecha Nexus:
...
## System 9: Build Fighters — MechKit Builder

**Series Basis:** Mecha Build Fighters / Build Divers  
...
Build Fighters fundamentally repositioned Mecha from "war narrative" to "hobbyist creativity." Sei and Reiji win not because they have the most powerful suit, but because Sei's builder craftsmanship has produced a MechKit that expresses his understanding of the machine. Mecha Nexus operationalizes this through a modular part system where mixing parts across timelines, scales, and series is not just allowed — it's the point.

### Part Categories

Every suit in Mecha Nexus is composed of 6 part slots:

| Slot | Stat Influence | Examples |
|------|---------------|---------|
| Head | Radar range (enemy distance visibility in arena) | GruntUnit monoeye, Wing fin antennae, Barbatos sensor unit |
| Torso | HP modifier (+/- max HP%) | Strike chest armor, Nu Mecha psycoframe torso, Epyon energy system |
| Arms | Attack damage (+/- ATK base) | Exia GN blade arm, Barbatos mace arm, Destiny dual-saber arms |
| Legs | Dodge range and speed | Freedom high-speed legs, GruntUnit long-range legs, Barbatos Lupus Rex high-mobility legs |
...
Each part's passive ability is a short text description of a constant effect (e.g., "GruntUnit Monoeye Head — Passive: Radar reveals opponent's equipped Striker Pack at match start").
...
847 unique parts at launch, mirroring the approximate count of distinct MechKit kit variants as of the game's production date. Each part has 3 quality tiers (Standard, Ace, Legend), for a total of 2,541 part variants to collect. The Legend-tier version of any part has a secondary passive ability (printed in gold text in the inventory UI).
...
**Series Basis:** Mobile Suit Mecha (original / One Year War through Char's Counterattack)  
...
Newtypes — humanity's next evolutionary step — perceive things others cannot: incoming attacks, emotional states, the flow of a battle. The original Mecha series codified this as "Newtype Flash," the bright resonance that occurs when two Newtypes' senses clash. In Mecha Nexus, the Newtype Flash is the visual signature of a perfect parry, and the Newtype Gauge represents accumulated resonance — the player's connection to the battle growing sharper the more precisely they fight.
...
**Amuro Ray's XM-01-2 (or any Amuro pilot item):**
...
- At gauge 100% and I-Field active simultaneously: Nu Mecha displays "Psycho-Frame Resonance" — I-Field lasts 5 blocks instead of 3
