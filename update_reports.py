...
os.makedirs("/Users/sac/rocket-craft/docs", exist_ok=True)
with open("/Users/sac/rocket-craft/VERIFIER_REPORT_GC_MECH_FACTORY_MUD_001.md", "w") as f:
    f.write(content)
with open("/Users/sac/rocket-craft/docs/GGEN_SOURCE_CAPABILITY_AUDIT.md", "a") as f:
    f.write(content)

with open("/Users/sac/rocket-craft/VERIFIER_REPORT_GC_MECH_FACTORY_MUD_001.json", "w") as f:
    f.write('{"status": "GGEN_AUTHORED_MUD_VERTICAL_SLICE_VERIFIED_UNDER_SCOPE", "tests_passed": 51}')
