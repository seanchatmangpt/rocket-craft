...
| MORPHOLOGY_FEATHER_CURVATURE | feather_panel_curvature_score >= 0.10 | >=0.10 | 1.0 | PASSED |
| MORPHOLOGY_FEATHER_OVERLAP | feather_overlap_depth_score >= 0.10 | >=0.10 | 1.0 | PASSED |
| MORPHOLOGY_CORE_COMPACTNESS | core_compactness_delta <= 0.15 | <=0.15 | 0.0 | PASSED |
| MORPHOLOGY_HEAD_TORSO_RATIO | head_to_torso_ratio_delta <= 0.15 | <=0.15 | 0.0 | PASSED |
| MORPHOLOGY_BLADE_GEOMETRY | blade_length_angle_delta <= 15.0 | <=15.0 | 0.0 | PASSED |
| MORPHOLOGY_ARMOR_SEGMENTATION | armor_shell_segmentation_score >= 0.04 | >=0.04 | 1.0 | PASSED |
| MORPHOLOGY_EDGE_DENSITY | edge_density_distribution similarity >= 0.60 | >=0.60 | 1.0 | PASSED |
| MORPHOLOGY_COMPONENTS | 1 <= foreground_component_count <= 5 | [1,5] | 1 | PASSED |
