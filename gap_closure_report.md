...
All 19 checks were evaluated. Passed: 30, Failed: 0.
...
| USD_PRIM_COUNT_GE_120 | usd_prim_count >= 120 | >=120 | 1087 | PASSED |
| WING_FEATHER_COUNT_GE_48 | wing_feather_count >= 48 | >=48 | 864 | PASSED |
| MATERIAL_BINDINGS_GE_4 | material_binding_count >= 4 | >=4 | 976 | PASSED |
...
| SILHOUETTE_IOU_GE_025 | silhouette_iou >= 0.25 | >=0.25 | 0.4064061942691686 | PASSED |
| COLOR_PALETTE_SIMILARITY_GE_050 | color_palette_similarity >= 0.50 | >=0.50 | 0.8818952778924449 | PASSED |
| MORPHOLOGY_PART_GRAPH_SIMILARITY | part_graph_similarity >= 0.90 | >=0.90 | 1.0 | PASSED |
| MORPHOLOGY_WING_LAYERS | wing_layer_count_delta <= 1.0 | <=1.0 | 0.0 | PASSED |
| MORPHOLOGY_FEATHER_CURVATURE | feather_panel_curvature_score >= 0.10 | >=0.10 | 0.18410041841004182 | PASSED |
| MORPHOLOGY_FEATHER_OVERLAP | feather_overlap_depth_score >= 0.10 | >=0.10 | 1.0 | PASSED |
| MORPHOLOGY_CORE_COMPACTNESS | core_compactness_delta <= 0.15 | <=0.15 | 0.10909393926940464 | PASSED |
| MORPHOLOGY_HEAD_TORSO_RATIO | head_to_torso_ratio_delta <= 0.15 | <=0.15 | 0.016666666666666607 | PASSED |
| MORPHOLOGY_BLADE_GEOMETRY | blade_length_angle_delta <= 15.0 | <=15.0 | 5.608335775166283 | PASSED |
| MORPHOLOGY_ARMOR_SEGMENTATION | armor_shell_segmentation_score >= 0.04 | >=0.04 | 0.11520409239531695 | PASSED |
| MORPHOLOGY_EDGE_DENSITY | edge_density_distribution similarity >= 0.60 | >=0.60 | 0.6793008711487907 | PASSED |
| MORPHOLOGY_COMPONENTS | 1 <= foreground_component_count <= 5 | [1,5] | 3 | PASSED |
| USD_MODULAR_IDENTITY | No USD modularity errors | 0 | 0 | PASSED |
...
|---|---|---|
| DOUBLE_WING_FEATHERS | Double the mecha wing feathers to increase thrust capacity | wing_feather_count: +864, usd_prim_count: +864, material_binding_count: +864 |
| HALF_WING_FEATHERS | Reduce mecha wing feathers by half to decrease drag | wing_feather_count: -432, usd_prim_count: -432, material_binding_count: -432 |
...
| DECREASE_CORE_BODY_WIDTH | Decrease mecha body core torso width by 10% | body_mass_delta: -0.1 |
| INCREASE_WING_SPAN | Increase mecha wingspan to 1195px to match reference target span | wing_span_delta: -39.5 |
