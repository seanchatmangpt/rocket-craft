# Research Dossier: `pcp`

**Total Files:** 2 Ontologies (.ttl) | 0 Queries (.rq)
**Total Volume:** 2 files

## 1. Core Vocabularies (Prefixes)
- `bos: <http://bible.o.star/ontology#>`
...
- `/Users/sac/pcp/packages/framework/src/ontology/bos.ttl` (2163 bytes)
- `/Users/sac/pcp/src/ontology/bos.ttl` (2163 bytes)
