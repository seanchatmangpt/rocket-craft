...
use nexus_mecha::mech_primitives::{Mars, PlanetCategory, RotationLimits, Venus, AABB};
...
#[serde(bound = "")]
pub struct CulturalProfile<P = nexus_mecha::mech_primitives::Earth> {
...
#[serde(bound = "")]
pub struct MechAssemblySpec<State = Unvalidated, P = nexus_mecha::mech_primitives::Earth> {
    pub frame: Frame,
...
/// };
/// use nexus_mecha::mech_primitives::{Earth, AABB};
///
/// let frame = Frame {
...
mod tests {
    use super::*;
    use nexus_mecha::mech_primitives::Earth;
