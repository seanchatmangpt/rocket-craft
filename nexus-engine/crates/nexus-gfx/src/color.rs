...
pub struct LinearRgb { r: f32, g: f32, b: f32 }
...
impl LinearRgb {
    ...
    pub fn to_srgb(&self) -> [u8; 3] {
        ...
        [to_srgb_channel(self.r), to_srgb_channel(self.g), to_srgb_channel(self.b)]
    }
    // Beam saber colors per series
    pub const NU_GUNDAM_GREEN: LinearRgb = LinearRgb { r: 0.0, g: 1.0, b: 0.3 };
    pub const WING_ZERO_GOLD: LinearRgb = LinearRgb { r: 1.0, g: 0.84, b: 0.0 };
    pub const UNICORN_NT_D_RED: LinearRgb = LinearRgb { r: 1.0, g: 0.1, b: 0.0 };
    pub const FREEDOM_BLUE: LinearRgb = LinearRgb { r: 0.2, g: 0.4, b: 1.0 };
    pub const AERIAL_GREEN: LinearRgb = LinearRgb { r: 0.1, g: 1.0, b: 0.4 };
}
