...
/// A builder for constructing a custom Mecha/Mech assembly with typestate safety.
///
...
///
/// ```
/// use nexus_mecha::builder::{MechBuilder, Set, Unset};
/// use nexus_mecha::mech_primitives::{Frame, Power, Armor, Flight, Mobility, AABB};
///
...
///
/// ```
/// use nexus_mecha::builder::{CivilizationBuilder, Set, Unset};
