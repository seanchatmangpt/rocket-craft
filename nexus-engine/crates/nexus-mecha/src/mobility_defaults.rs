// Mobility Default implementations — lore-grounded from UC Mecha official tech manuals.
// Physical quantities annotated with QUDT 2.1 units (https://qudt.org/).
// Source of truth: nexus-engine/.specify/schema/mecha_nexus.ttl
...
impl Default for Mobility {
    /// Canonical baseline: XM-01-2 Mecha (UC 0079) bipedal locomotion spec.
...
impl Default for Walking {
    /// XM-01-2 Mecha (UC 0079): bipedal, 2 legs, 165 km/h (45.83 m/s) ground speed.
    /// Source: Bandai MG 1/100 XM-01-2 Mecha Ver.3.0 instruction manual.
    fn default() -> Self {
        Self {
...
impl Default for Flight {
    /// Wing Mecha (XXXG-01W, AC 195): 7,150 kg, Mach 1+ (≥340 m/s), 14.4m wing span.
    /// Source: Mecha Wing MG 1/100 Wing Mecha instruction manual + Endless Waltz specs.
    fn default() -> Self {
        Self {
            physical: Mobility {
                id: "wing-mecha-flight-baseline".to_string(),
                mass: 7_150.0,
                occupancy: AABB::default(),
                clearance: AABB::default(),
...
impl Default for Hover {
    ...
    /// Source: Z Mecha setting notes / Zeta-era design documentation.
    fn default() -> Self {
        Self {
            physical: Mobility {
