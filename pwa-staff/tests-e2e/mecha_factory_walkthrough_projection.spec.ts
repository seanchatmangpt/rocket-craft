...
test.describe('Mecha Factory Walkthrough Projection E2E', () => {
  test('verify mecha factory walkthrough and generate receipt', async ({ page }) => {
    ...
    try {
      ...
      // Has motion: > idleDeltaPixels + 35
      const threshold = idleDeltaPixels + 35;
      ...
      const receiptPath = path.join(resultsDir, 'mecha-factory-playwright-receipt.json');
      ...
      const diffPath = path.join(resultsDir, 'mecha-factory-diff.png');
