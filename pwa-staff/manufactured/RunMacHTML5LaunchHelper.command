...
EPIC_MONO=""
if [ -f "/Users/sac/ue-4.27-html5-es3/Engine/Build/BatchFiles/Mac/SetupMono.sh" ]; then
    pushd "/Users/sac/ue-4.27-html5-es3/Engine/Build/BatchFiles/Mac"
	source SetupMono.sh
    popd
else
	EPIC_MONO="NOTE: It seems this $0 was built from another platform and copied here.\nNOTE: Was expecting to setup mono via: "'/Users/sac/ue-4.27-html5-es3/Engine/Build/BatchFiles/Mac/SetupMono.sh';
fi
