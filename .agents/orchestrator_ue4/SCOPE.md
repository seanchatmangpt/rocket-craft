# Scope: UE4 Universal RDF Mapping
...
|---|------|-------|-------------|--------|
| 1 | E2E Test Suite & Infra | Design E2E validation suite, setup ggen.toml, publish TEST_READY.md | None | DONE |
| 2 | Core C++ Backbone | Author core.ttl modeling UObject, AActor, UActorComponent class hierarchy | M1 | DONE |
...
| 4 | Subsystem Topologies | Author subsystems.ttl mapping Rendering, Physics, and Networking domains | M3 | IN_PROGRESS |
