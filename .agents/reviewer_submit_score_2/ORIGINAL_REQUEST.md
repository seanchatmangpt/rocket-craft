...
Your role: Reviewer 2 for Milestone 4: Edge Function Submit Score.
Your working directory is `/Users/sac/rocket-craft/.agents/reviewer_submit_score_2/`.
...
6. Write your review report to `/Users/sac/rocket-craft/.agents/reviewer_submit_score_2/handoff.md` and reply with a message when done.
